...
namespace MTS_Solutions_Task.Report {
    ...
    public partial class EmployeesDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeesRow AddEmployeesRow(string FirstName, string LastName, string BirthDate, string Gender, string Email, string Department) {
        ...
        public partial class EmployeesRow : global::System.Data.DataRow {
            ...
            public string BirthDate {
                get {
                    return ((string)(this[this.tableEmployees.BirthDateColumn]));
                }
                set {
...
namespace MTS_Solutions_Task.Report.EmployeesDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employees] ([FirstName], [LastName], [BirthDate], [Gender], [E" +
                "mail], [Department]) VALUES (@FirstName, @LastName, @BirthDate, @Gender, @Email," +
                " @Department)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Employees] SET [FirstName] = @FirstName, [LastName] = @LastName, [B" +
                "irthDate] = @BirthDate, [Gender] = @Gender, [Email] = @Email, [Department] = @De" +
                "partment WHERE (([Id] = @Original_Id))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["EmployeesDbConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FirstName, LastName, BirthDate, Gender, Email, Department FROM dbo.Emp" +
                "loyees";
        ...
        public virtual int Insert(string FirstName, string LastName, string BirthDate, string Gender, string Email, string Department) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, string BirthDate, string Gender, string Email, string Department, int Original_Id) {
            if ((FirstName == null)) {
                throw new global::System.ArgumentNullException("FirstName");
            }
            else {
